...
public final class ZWay {
    ...
    public Device.Instance.%cc_capitalized_name% %cc_camel_case_name%(Integer deviceId, Integer instanceId) {
        return ((ZWay.Device.Instance.%cc_capitalized_name%) devices.get(deviceId).instances.get(instanceId).commandsByName.get("%cc_camel_case_name%"));
    }
    * END AUTOGENERATED CC TEMPLATE */
        ...
        if (type == deviceAdded) {
            ...
            switch (commandClassId) {
                ...
                case %cc_id%:
                    ...
                    instance.commands.put(commandClassId, command%cc_capitalized_name%);
                    instance.commandsByName.put("%cc_camel_case_name%", command%cc_capitalized_name%);
                 * END AUTOGENERATED CC TEMPLATE */
            }
            ...
            switch (commandClassId) {
                /* BEGIN AUTOGENERATED CC TEMPLATE
                case %cc_id%:
                    instance.commandsByName.remove("%cc_camel_case_name%");
                 * END AUTOGENERATED CC TEMPLATE */
            }
    ...
    public final class Device {
        ...
        public final class Instance {
            ...
            public Instance(ZWay zWay, Device dev, Integer instance_id) {
                jzway = zWay.jzway;
                device = dev;
                id = instance_id;
            ...
            public class Command {
                ...
                public Command(ZWay zWay, Instance inst) {
                    jzway = zWay.jzway;
                    instance = inst;
                }
            }
            ...
            /* BEGIN AUTOGENERATED CC TEMPLATE
            public final class %cc_capitalized_name% extends Command {
                public final static int id = %cc_id%;

                public %cc_capitalized_name%(ZWay zWay, Instance instance) {
                    super(zWay, instance);
                }
