...
public final class ZWay {
    ...
    * END AUTOGENERATED CC TEMPLATE */
    ...
    private native void jni_fc_%function_short_camel_case_name%(long ptr, %params_java_declarations%long successCallback, long failureCallback, long callbackArg);
    ...
    public void %function_command_camel_name%(%params_java_declarations%long successCallback, long failureCallback, long callbackArg) {
        jni_fc_%function_short_camel_case_name%(jzway, %params_java%successCallback, failureCallback, callbackArg);
    }
    public void %function_command_camel_name%(%params_java_declarations_no_comma%) {
        jni_fc_%function_short_camel_case_name%(jzway, %params_java%0, 0, 0);
    }
    ...
    public final class Device {
        ...
        public final class Instance {
             ...
             * BEGIN AUTOGENERATED CMD TEMPLATE
                public void %function_command_camel_name%(%params_java_declarations%long successCallback, long failureCallback, long callbackArg) {
                    jni_cc_%function_short_camel_case_name%(jzway, instance.device.id, instance.id, %params_java%successCallback, failureCallback, callbackArg);
                }
                public void %function_command_camel_name%(%params_java_declarations_no_comma%) {
                    jni_cc_%function_short_camel_case_name%(jzway, instance.device.id, instance.id, %params_java%0, 0, 0);
                }
