...
static void jni_fc_%function_short_name%(JNIEnv *env, jobject obj, jlong jzway, %params_jni_declarations%jlong arg) {
    (void)env;
    (void)obj;
...
static JNINativeMethod funcs[] = {
    ...
    /* BEGIN AUTOGENERATED FC TEMPLATE
    { "jni_fc_%function_short_camel_case_name%", "(J%params_signature%JJJ)V", (void *)&jni_fc_%function_short_name% },
     * END AUTOGENERATED FC TEMPLATE */
    /* BEGIN AUTOGENERATED CC TEMPLATE
     * BEGIN AUTOGENERATED CMD TEMPLATE
